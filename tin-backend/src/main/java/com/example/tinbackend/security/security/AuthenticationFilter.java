package com.example.tinbackend.security.security;

import com.example.tinbackend.security.config.TokenProperties;
import com.example.tinbackend.security.domain.user.dto.UserCredentials;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    private UsernamePasswordAuthenticationToken createAuthenticationToken(UserCredentials userCredentials){
